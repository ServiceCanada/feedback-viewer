...
/**
 * Service to validate if an IP address is owned by the Government of Canada Uses RDAP (Registration
 * Data Access Protocol) API to check IP ownership
 */
@Service
public class GcIpValidationService {
  ...
  /**
   * Check if an IP address is owned by the Government of Canada Results are cached for 24 hours to
   * avoid excessive RDAP API calls
   *
